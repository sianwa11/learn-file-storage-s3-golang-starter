...
func (cfg *apiConfig) handlerUploadThumbnail(w http.ResponseWriter, r *http.Request) {
	...
	if parsedMediaType != "image/jpeg" && parsedMediaType != "image/png" {
		respondWithError(w, http.StatusBadRequest, "only accepts jpegs and pngs", nil)
		return
	}
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Unalble to create file on server", err)
		return
	}
	defer dst.Close()
